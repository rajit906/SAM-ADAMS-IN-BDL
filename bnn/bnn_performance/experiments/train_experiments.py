...
parser.add_argument("--model", type=str, default="classificationconvnet")
parser.add_argument("--data", type=str, default="mnist")
parser.add_argument("--inference", type=str, default="VanillaSGLD")
parser.add_argument("--lrs", nargs="+", type=float, default=[0.0005])
...
parser.add_argument("--save_samples", type=str, default="True")
